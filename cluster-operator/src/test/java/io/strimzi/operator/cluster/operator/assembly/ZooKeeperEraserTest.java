...
public class ZooKeeperEraserTest {
    ...
    @Test
    public void testZookeperEraserReconcilePVCDeletionWithDeleteClaimTrue(VertxTestContext context) {
    ...
    @Test
    public void testZookeperEraserReconcilePVCDeletionWithDeleteClaimFalse(VertxTestContext context) {
        ...
        ZookeeperCluster zkCluster = ZookeeperCluster.fromCrd(Reconciliation.DUMMY_RECONCILIATION, patchedKafka, VERSIONS, SHARED_ENV_PROVIDER);
        ResourceOperatorSupplier supplier = ResourceUtils.supplierWithMocks(false);
        ServiceAccountOperator mockSaOps = supplier.serviceAccountOperations;
        ServiceOperator mockServiceOps = supplier.serviceOperations;
        NetworkPolicyOperator mockNetPolicyOps = supplier.networkPolicyOperator;
