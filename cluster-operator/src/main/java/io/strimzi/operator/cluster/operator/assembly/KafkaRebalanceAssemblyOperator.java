    ...
    private Future<MapAndStatus<ConfigMap, KafkaRebalanceStatus>> requestRebalance(Reconciliation reconciliation, String host, CruiseControlApi apiClient, KafkaRebalance kafkaRebalance,
        ...
        switch (mode) {
            ...
            case REMOVE_BROKERS:
                ...
                break;
            case REMOVE_DISKS:
                future = apiClient.removeBrokerDisksData(reconciliation, host, cruiseControlPort, ((RemoveDisksOptions.RemoveDisksOptionsBuilder) rebalanceOptionsBuilder).build(), userTaskID);
                break;
            default:
